...
$tabla1->cargar(1,1,"titulo 1","#fff","#000000");
$tabla1->cargar(1,2,"titulo 2","#fff","#000000");
$tabla1->cargar(1,3,"titulo 3","#fff","#000000");
for($f=2;$f<=10;$f++)
{
  $tabla1->cargar($f,1,"1","#fff","#000000");
  $tabla1->cargar($f,2,"2","#fff","#000000");
  $tabla1->cargar($f,3,"3","#fff","#000000");
}
$tabla1->graficar();
?>
</body>
